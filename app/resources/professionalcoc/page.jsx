  ...
  return (
    ...
    <Container>
      ...
      <BulletList>
        ...
        <ListItem>
          <span>Politeness and Confidentiality:</span> Engineering services for
          customers should be dealt with in a polite manner and professional
          information should remain confidential except with written or verbal
          consent of the customers concerned. This, however, is not deemed to be
          a restriction to provide such information to the concerned authority
          as per the existing laws.
        </ListItem>
        <ListItem>
          <span>Non-discrimination:</span> No discrimination should be made
          against customers on the grounds of religion, race, sex, caste or any
          other things while applying professional knowledge and skills.
        </ListItem>
        <ListItem>
          <span>Professional Work:</span> Individuals should only do
          professional work in their field or provide recommendations or
          suggestions only within the area of their subject of study or obtained
          knowledge or skills. With regard to the works not falling within the
          subject of one's profession, such works should be recommended to be
          done by an expert of that subject matter.
        </ListItem>
        <ListItem>
          <span>Deeds which may cause harm to the engineering profession:</span>{" "}
          With the exception of salary, allowance and benefits to be received
          for services provided, one shall not obtain improper financial gain of
          any kind or conduct improper activities of any kind, which would
